...
const MainHeader: React.FC = function () {
    ...
    return (
        <>
            {!hideHeader &&
                <header className="sticky top-0 z-50 h-[72px] flex justify-center bg-white border-b shadow-sm shadow-gray-600" >
                    <div className="h-full max-w-[60rem] w-[95%] flex items-center justify-between">
                        ...
                        <div className="h-full max-w-[12rem] w-[30%] flex flex-row items-center justify-between">
                            ...
                            <NavLink to="/login">
                                <button type="button" className="text-[0.9rem] bg-white px-[0.75rem] h-[2.75rem] text-[#0A5EB0] rounded-full transition-colors duration-300  hover:text-[#0A5EB0] hover:font-bold hover:bg-[#EBEAFF] ">sign in
                                </button>
                            </NavLink>
                        </div>
                    </div>
