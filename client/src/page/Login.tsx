        ...
        <div className="h-full w-full flex justify-center">
            <div id="login-box" className="relative w-[80%] mt-[2rem] min-h-[18rem] max-w-[20rem] rounded-sm shadow-sm shadow-gray-400 flex flex-col" >
                ...
                <div id="password-box" className="flex flex-col px-[1rem] text-[0.75rem] mt-[0.5rem]">
                    ...
                    <input type="text" className="h-[2rem] rounded-r-lg bg-[#FBFBFB] shadow-sm shadow-gray-300 px-[0.25rem] focus:outline-none focus:bg-[#FFFBF5] focus:border-l-[3px] border-[#003161] text-[0.75rem] transition-colors duration-400" placeholder="enter your password"
